...
public class PeerViewModel extends AndroidViewModel {
    ...
    /*
    *   add function signature and definition code for
    *   1. fetchMessagesFromPeer(Peer peer)
    *   2. loadMessages(Peer peer)
    * */
    ...
    public LiveData<List<Message>> loadMessages(Peer peer) {
        currentPeer = peer;
        return chatDatabase.messageDao().fetchMessagesFromPeer(currentPeer.name);
    }
