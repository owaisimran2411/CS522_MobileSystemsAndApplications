...
public class ChatActivity extends AppCompatActivity implements ChatroomsFragment.IChatroomListener, MessagesFragment.IChatListener, SendMessage.IMessageSender {
	...
	public void onResume() {
        // TODO enable synchronization of messages with chat server (Assignment 10)
        super.onResume();
        chatHelper = new ChatHelper(ChatActivity.this);
        chatHelper.startMessageSync();
        //super.onResume();
    ...
    public void onPause() {
        // TODO stop synchronization of messages with chat server (Assignment 10)
        super.onPause();
        Log.d(TAG, "onPause(): is called here ---");
